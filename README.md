# genpark-role-playing-autonomous-agent-crew-orchestrator-skill
...
> **GenPark AI Agent Skill** -- Role-playing autonomous agent orchestrator managing crews (CrewAI style)
